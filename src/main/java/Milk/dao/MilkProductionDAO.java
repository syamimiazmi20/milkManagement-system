...
public class MilkProductionDAO {
    ...
    public List<MilkProduction> getAllMilkProduction() {
        ...
        try (Connection con = ConnectionManager.getConnection()) {
            ...
            System.err.println("Error fetching all milk productions: " + e.getMessage());
            e.printStackTrace();
        }
    ...
    public boolean addMilkProduction(MilkProduction milk) {
        ...
        try (Connection con = ConnectionManager.getConnection();
            ...
            System.err.println("Error adding milk production: " + e.getMessage());
            e.printStackTrace();
        }
        return false;
    }
    ...
    public MilkProduction getMilkProductionById(int id) throws SQLException {
        ...
        try (Connection con = ConnectionManager.getConnection();
            ...
            System.err.println("Error fetching milk production by ID: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
        return milk;
    ...
    public static MilkProduction getLatestMilkProduction() throws SQLException {
        MilkProduction milk = new MilkProduction();
        String query = "SELECT * FROM (SELECT * FROM milkproduction ORDER BY production_id DESC LIMIT 1) sub";
        try (Connection con = ConnectionManager.getConnection();
             PreparedStatement ps = con.prepareStatement(query);
             ResultSet rs = ps.executeQuery()) {
            if (rs.next()) {
            ...
            System.err.println("Error fetching latest milk production: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
        return milk;
    ...
    public static double getLatestMilkProductionAmtBal() throws SQLException {
        double amtbal = 0.0;
        String query = "SELECT amount_balance FROM milkproduction ORDER BY production_id DESC LIMIT 1";
        try (Connection con = ConnectionManager.getConnection();
             PreparedStatement ps = con.prepareStatement(query);
             ResultSet rs = ps.executeQuery()) {
            if (rs.next()) {
            ...
            System.err.println("Error fetching latest milk production amount balance: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
        return amtbal;
    ...
    public void updateMilkProduction(MilkProduction milk) {
        ...
        try (Connection con = ConnectionManager.getConnection();
            ...
            System.err.println("Error updating milk production: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public static int getLatestMilkProductionProdId() throws SQLException {
        int prodId = 0;
        String query = "SELECT production_id FROM milkproduction ORDER BY production_id DESC LIMIT 1";
        try (Connection con = ConnectionManager.getConnection();
             PreparedStatement ps = con.prepareStatement(query);
             ResultSet rs = ps.executeQuery()) {
            if (rs.next()) {
            ...
            System.err.println("Error fetching latest milk production ID: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
        return prodId;
    ...
    public static double getMilkProductionAmount(int productionId) throws SQLException {
        ...
        try (Connection con = ConnectionManager.getConnection();
            ...
            System.err.println("Error fetching milk production amount: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
        return amount;
    ...
    public void updateMilkProductionAmtBal(double newAmtBal, int prodId) throws SQLException {
        ...
        try (Connection con = ConnectionManager.getConnection();
            ...
            System.err.println("Error updating milk production amount balance: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
    }
    ...
    public double getTotalMilkProductionLast30Days() throws SQLException {
        String query = "SELECT SUM(total_production) FROM milkproduction WHERE production_date >= CURRENT_DATE - INTERVAL '30 days'";
        try (Connection con = ConnectionManager.getConnection();
             PreparedStatement ps = con.prepareStatement(query);
             ResultSet rs = ps.executeQuery()) {
            if (rs.next()) {
            ...
            System.err.println("Error fetching total milk production for the last 30 days: " + e.getMessage());
            e.printStackTrace();
            throw e;
        }
        return 0;
